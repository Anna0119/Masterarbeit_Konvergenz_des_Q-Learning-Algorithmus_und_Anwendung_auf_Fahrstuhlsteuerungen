...
while continue_simulation_2 == True:
    ...
    for i in all_states:
        ...
        for j in range(0,5):
            ...
            this_state_2 = {'call_requests: ': list(first_state_2[0]), 'elevator_position: ': first_state_2[1], 'elevator_target: ': list(first_state_2[2])}
...
while continue_simulation_3 == True:
    ...
    for i in all_states:
        ...
        for j in range(0,5):
            ...
            this_state_3 = {'call_requests: ': list(first_state_3[0]), 'elevator_position: ': first_state_3[1], 'elevator_target: ': list(first_state_3[2])}
...
plt.title("Performance der Agenten innerhalb von 100 Test-Episoden")
plt.legend()
plt.grid(True)
plt.show()
plt.close()
...
# Vergleich der Konvergenz der Approximationsfunktionen für verschiedene Ankunftsraten
