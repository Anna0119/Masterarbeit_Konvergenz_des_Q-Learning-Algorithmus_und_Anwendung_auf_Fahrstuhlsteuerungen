...
while continue_simulation == True:
    ...
    # Die neue Q-Funktion wird vor der Aktualisierung zwischengespeichert für die Distanzberechnung
    old_q_table = copy.deepcopy(agent.q_table)
...
# Abbildung der Entwicklung des euklidischen Abstands zweier aufeinanderfolgender Q-Funktionen
...
fig.suptitle('Veränderung der Distanz zwischen zwei Q-Funktionen')
