...
class QLearningAgent:
    ...
    def __init__(self):
        ...
        self.exploration_rate_count = defaultdict(lambda: np.full((1,), 0))
...
while continue_simulation_2 == True:
    ...
    while continue_simulation == True:
        ...
        epsilon_greedy = 0.05/agent.exploration_rate_count[tuple(this_state)] # individuell abnehmende Explorationsrate
